...
[![Platform](https://img.shields.io/badge/platform-Android%20%7C%20iOS-lightgrey.svg?style=flat)](https://github.com/Farajialireza82/BoxTimerPro)
...
- **Background Support** - Timer continues running even when app is minimized with foreground service
- **Active Notifications** - Real-time timer status displayed in notification with controls
...
- **Dynamic Animations** - Visual feedback that adapts to timer status (running, paused, rest)

### 🌍 Localization & Accessibility
- **Multi-Language Support** - Full support for English and Farsi (فارسی)
- **RTL Support** - Proper right-to-left layout for Persian and other RTL languages
- **Light & Dark Mode** - Seamless theming that adapts to system preferences or manual selection
...
- **Screen Management** - Keep screen on during active workouts, optional auto-rotation
- **Workout Stats** - Real-time tracking of total time, calories, and completed rounds
- **Analytics** - Built-in Yandex Analytics for usage insights and app improvements
...
- **Foreground Services** - Reliable background timer execution
...
## 🌐 Language Support
BoxTimer Pro fully supports:
* **English** - Complete UI translation
* **فارسی (Farsi)** - Complete UI translation with RTL layout

Language can be changed in **Settings → Language** or set to follow system preferences.
